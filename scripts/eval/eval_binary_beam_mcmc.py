...
from transformers_gad.generation.mcmc_process import RawMCMCHolder, BeamMCMC
...
def main():
    ...
    holder = BeamMCMC(input_ids[0], generator, beam_search, tokenizer, grammar, DEVICE)
    history = []
    ...
    with open(f"{RESULT_PATH}/{id}/{id}_beam_mcmc.jsonl", "w") as f:
